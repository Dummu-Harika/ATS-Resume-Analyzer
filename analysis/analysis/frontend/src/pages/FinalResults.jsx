                ...
                <div className="param-sections">
                    <div className="param-section">
                        ...
                        <div className="p-grid">
                            <div className="p-item"><span>Confidence</span> <strong>{evaluations[0]?.audio.vocal_confidence.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Fluency</span> <strong>{evaluations[0]?.audio.speech_fluency.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Tone</span> <strong>{evaluations[0]?.audio.emotional_tone.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Clarity</span> <strong>{evaluations[0]?.audio.voice_clarity.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Consistency</span> <strong>{evaluations[0]?.audio.tone_consistency.score.toFixed(1)}/10</strong></div>
                        </div>
                    </div>
                    <div className="param-section">
                        <h3>👁️ Visual & Body Language</h3>
                        <div className="p-grid">
                            <div className="p-item"><span>Eye Contact</span> <strong>{evaluations[0]?.video.eye_contact.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Posture</span> <strong>{evaluations[0]?.video.body_language.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Expressions</span> <strong>{evaluations[0]?.video.facial_expressions.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Appearance</span> <strong>{evaluations[0]?.video.professional_appearance.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Engagement</span> <strong>{evaluations[0]?.video.engagement_level.score.toFixed(1)}/10</strong></div>
                        </div>
                    </div>
                    <div className="param-section">
                        <h3>💡 Answer Content Quality</h3>
                        <div className="p-grid">
                            <div className="p-item"><span>Communication</span> <strong>{evaluations[0]?.content.communication_skills.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Cultural Fit</span> <strong>{evaluations[0]?.content.cultural_fit.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Motivation</span> <strong>{evaluations[0]?.content.motivation.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Problem Solving</span> <strong>{evaluations[0]?.content.problem_solving.score.toFixed(1)}/10</strong></div>
                            <div className="p-item"><span>Maturity</span> <strong>{evaluations[0]?.content.professional_maturity.score.toFixed(1)}/10</strong></div>
                        </div>
                    </div>
                </div>
            </div>
